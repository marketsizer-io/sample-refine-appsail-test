    Sample Refine application in AppSail
...
3. From the Appsail directory({Your project directory}/Refine/), initialize a new Refine app by using the below command. Enter the defaults.
